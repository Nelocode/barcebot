...
.card-header { background: #16213e; border-bottom: 1px solid #2a2a4a; font-weight: 600; color: #a8d8ea; }
.form-control, .form-select { background: #0f0f1a; border: 1px solid #2a2a4a; color: #e0e0e0; }
.form-control:focus { background: #1a1a2e; border-color: #4a90d9; color: #fff; box-shadow: 0 0 0 0.2rem rgba(74,144,217,0.25); }
.btn-primary { background: #4a90d9; border: none; }
.btn-primary:hover { background: #357abd; }
.btn-danger { background: #e74c3c; border: none; }
.btn-success { background: #27ae60; border: none; }
.btn-sm { font-size: 0.8rem; }
.audio-preview { display: flex; align-items: center; gap: 10px; }
.audio-preview audio { height: 32px; }
.language-tabs { display: flex; gap: 8px; margin-bottom: 1rem; }
.language-tabs .btn { flex: 1; }
.badge-es { background: #e67e22; }
.badge-en { background: #3498db; }
.badge-fr { background: #9b59b6; }
.status-dot { width: 10px; height: 10px; border-radius: 50%; display: inline-block; margin-right: 6px; }
.status-online { background: #27ae60; }
.status-offline { background: #e74c3c; }
.step-label { font-size: 0.85rem; color: #888; text-transform: uppercase; letter-spacing: 1px; }
textarea { min-height: 60px; resize: vertical; }
hr { border-color: #2a2a4a; }
#toast-container { position: fixed; top: 20px; right: 20px; z-index: 9999; }
.toast-msg { background: #1a1a2e; color: #e0e0e0; border: 1px solid #2a2a4a; padding: 12px 20px; border-radius: 8px; margin-bottom: 8px; animation: fadeIn 0.3s; }
